            ...
            <div class="col-lg-6">
                ...
                <form role="form" action="Produtos" method="POST" id="cadastraProduto">
                    ...
                    <div class="form-group <c:if test="${produto.id != null}">class="hide"</c:if>">
                         <label class="col-lg-4">Tipo de produto</label>
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <h4 class=""  >
                                <c:if test="${produto.tipo == 'C'}">Comida</c:if> 
                                <c:if test="${produto.tipo == 'B'}">Bebida</c:if> 
                            </h4>
                        </c:otherwise>
                    </c:choose>
                </div>
                ...
                <div id='form-details' <c:if test="${produto.id == null}">class="hide"</c:if> >
                    <div class="form-group <c:if test="${produto.id == null}">hide"</c:if>">
